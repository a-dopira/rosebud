...
const Dropdown = memo(({
    ...
    return (
      ...
      >
        <ul 
          ...
          style={{
            maxHeight: filteredOptions.length > maxVisibleItems ? `${maxVisibleItems * 41}px` : 'auto',
  ...
  }, [isOpen, filteredOptions, dropdownPosition, maxVisibleItems, dropdownClassName, itemClassName, handleItemSelect]);
