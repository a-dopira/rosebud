...
/**
 * Generic New Product Form component that can be used for all product types
 * @param {Object} props - Component props
 * @param {Function} props.setRose - Function to update rose state
 * @param {String} props.apiEndpoint - API endpoint for the product
 * @param {Function} props.setShowForm - Function to toggle form visibility
